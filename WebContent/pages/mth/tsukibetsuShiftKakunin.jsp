...
<%-- ヘッダーの読込 --%>
		...
		<main class="formStyle">
			...
			<div class="btn btn__bonrei">
				<input value="凡例表示" type="button" class="lngButton buttom" style="height: 40px;"  onclick="openWindow()"  />
			</div>
		</main><%-- main --%>
		
		<footer class="footer">
			<div class="footer_btn footer_btn__left">
				<input value="印刷" type="button" class="smlButton buttom"  onclick="submitPrint()" />
			</div>
		</footer><%-- footer --%>
